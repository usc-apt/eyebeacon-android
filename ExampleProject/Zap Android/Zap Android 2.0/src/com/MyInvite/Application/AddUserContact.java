...
public class AddUserContact extends SherlockActivity implements OnClickListener{
		...
		case R.id.bAddUserSubmit:
			AsyncTask<String, Void, String> task = new AsyncTask<String, Void, String>() {
				...
				protected String doInBackground(String... arg0) {
					...
					response = DatabaseAccess.getData(Main.serverName + "AddUserToContacts.php", args);
					return null;
				}
				...
				protected void onPostExecute(String result) {
					if (response.charAt(0) != '0') {
						...
						final AlertDialog.Builder builder = new AlertDialog.Builder(AddUserContact.this);
