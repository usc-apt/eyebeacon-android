...
public class MyGroup extends SherlockListActivity implements OnClickListener {
		...
		if(!haveNetworkConnection()){
			...
			AsyncTask<String, Void, String> task = new AsyncTask<String, Void, String>() {
				...
				protected String doInBackground(String... arg0) {
					...
					response = DatabaseAccess.getData(AppUrls.GetGroupInfo, args);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
            switch(item.getItemId()) {
            	case R.id.iClickedGroupAdd:
            		Intent openContactList = new Intent("com.Zap.InstantConnection.Groups.ADDTOGROUP");
        				...
        				public void onClick(DialogInterface dialog, int id) {
        					AsyncTask<String, Void, String> task = new AsyncTask<String, Void, String>() {
        						...
        						protected String doInBackground(String... arg0) {
        							HashMap<String, String> args = new HashMap<String, String>();
                					args.put("groupid", groupid+"");
                					DatabaseAccess.getData(AppUrls.DeleteGroup, args);
                					finish();
        							return null;
        						}
        					};
			...
			if(!AppUtils.checkSomethingSelected(positionCheck)){
				...
				AsyncTask<String, Void, String> task = new AsyncTask<String, Void, String>() {
					...
					protected String doInBackground(String... arg0) {
						...
						try{
							arg.put("group_id", groupid+"");
							arg.put("user_ids", jsonArray);
						}catch(JSONException e){
							e.printStackTrace();
						}
						response = DatabaseAccess.sendJsonObject(AppUrls.RemoveUsersFromGroup, arg);
						//response = DatabaseAccess.sendJsonWithJsonArray(AppUrls.RemoveUsersFromGroup, "group_id", groupid+"","user_ids", jsonArray);
					...
					protected void onPostExecute(String result) {
						//progDailog.dismiss();
						AppUtils.showToast(MyGroup.this, "- Users Removed -");
						finish();
