...
public class AddGuestMenu extends SherlockActivity implements OnClickListener{
	...
	public void onClick(View arg0) {
		...
		case R.id.bAddGuestMenuAddNewUser:
			Intent openAddUser = new Intent("com.Zap.InstantConnection.Guests.ADDUSER");
			startActivity(openAddUser);
			finish();
			break;
		case R.id.bAddGuestMenuContactList:
			Intent openAddContact = new Intent("com.Zap.InstantConnection.Guests.ADDCONTACTS");
			startActivity(openAddContact);
			finish();
			break;
		case R.id.bAddGuestMenuAddGroup:
			Intent openAddGroup = new Intent("com.Zap.InstantConnection.Guests.ADDGROUPS");
