package com.Zap.InstantConnection.ChangeRequests;
...
public class ViewChangeRequests extends SherlockListActivity {
		...
		if (!haveNetworkConnection()) {
			...
			AsyncTask<String, Void, String> task = new AsyncTask<String, Void, String>() {
				...
				protected String doInBackground(String... arg0) {
					...
					response = DatabaseAccess.getData(AppUrls.ViewChangeRequests, args);
					return null;
				}
            ...
            switch(item.getItemId()) {
            	case R.id.iChangeRequestsAdd:
            		if(requested){
        				...
        				Intent openMakeRequest = new Intent("com.Zap.InstantConnection.ChangeRequests.MAKEREQUEST");
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try{
			Class ourClass = Class.forName("com.Zap.InstantConnection.ChangeRequests.ChangeRequestVote");
			Intent ourIntent = new Intent(ViewChangeRequests.this, ourClass);
